...
public class UtilitiesTest {
    ...
    @Test
    public void fromStringToDateUncorrectDate() throws Exception {

    }

    @Test
    public void roundUpBigDecimal() throws Exception {

    }

    @Test
    public void roundUpBigDecimalNullDate() throws Exception {
